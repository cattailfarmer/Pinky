...
from rh_math.explicit_formula import SUPPORTED_ZERO_WINDOWS, partial_summation_bridge_atlas
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Project explicit-formula psi estimates into Lambda-Mellin units by partial summation."
    )
