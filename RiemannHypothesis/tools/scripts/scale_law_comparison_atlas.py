...
from rh_math.explicit_formula import SUPPORTED_SCALE_LAWS, SUPPORTED_ZERO_WINDOWS, scale_law_comparison_atlas


def main() -> None:
    parser = argparse.ArgumentParser(description="Compare finite explicit-formula residual atlases across declared scale laws.")
    ...
    parser.add_argument("--scale-law", choices=list(SUPPORTED_SCALE_LAWS), action="append", help="Scale law. May be repeated.")
