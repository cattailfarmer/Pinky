...
from rh_math.explicit_formula import SUPPORTED_ZERO_WINDOWS, zero_height_cutoff_atlas


def main() -> None:
    parser = argparse.ArgumentParser(description="Build a finite explicit-formula residual atlas by zero-height cutoff T.")
    ...
    parser.add_argument("--zero-height", action="append", help="Positive zero-height cutoff T. May be repeated.")
