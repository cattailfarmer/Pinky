...
from rh_math.explicit_formula import SUPPORTED_ZERO_WINDOWS, lambda_mellin_bridge_atlas
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Project explicit-formula psi estimates into finite Lambda-Mellin units."
    )
